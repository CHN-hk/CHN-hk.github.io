// ==UserScript==
// @name         Zhengfang Course Assistant For PCs
// @namespace    https://void-lee.cn;https://chn-hk.github.io
// @version      3.0A
...
(() => {
    ...
    (() => {
        ...
        window.onload = function () {
            console.log("%c" + pro_info.author + "抢课助手v" + pro_info.version, "color:red"), $("body").prepend('<div style="background-color: black;height: 250px">\n    <style>\n        h1 {\n            color: white;\n            margin: 0;\n        }\n\n        select {\n            /*width: 190px;*/\n            border: 1px solid white;\n            background-color: black;\n            color: white;\n            outline: none;\n            height: 210px !important;\n            display: block;\n            padding: 5px 0 5px;\n            margin: 0 5px 0 5px;\n        }\n\n        #ok {\n            display: flex;\n            height: 190px;\n            align-items: center;\n        }\n\n        #button_domain {\n            margin: 10px;\n        }\n\n        .button_domain button {\n            width: 50px;\n            height: 25px;\n            background-color: black;\n            color: white;\n            border: 1px white solid;\n            cursor: pointer;\n            display: block;\n            margin: 5px;\n        }\n\n        .button_domain button:hover {\n            background-color: white;\n            color: black;\n        }\n\n        #inf {\n            display: flex;\n        }\n    </style>\n    <h2>ZhengfangCourseAssistant</h2>\n    <p style="color:#fff;" id="load">正在加载中。。。按f12查看详细情况。</p>\n    <div id="ok" style="display: none;">\n        <select id="cid" multiple="multiple" style="flex: 1;"></select>\n        <div id="inf" class="button_domain">\n            <select id="jxb" multiple="multiple" style="width: 190px"></select>\n            <div style="overflow-y: scroll;width: 190px;color: white;height: 190px"></div>\n        </div>\n        <span style="color: white">&gt;&gt;</span>\n        <select id="selected" multiple="multiple" style="flex: 1;"></select>\n        <div class="button_domain">\n            <button id="fetch">PICK</button>\n            <button id="stole">LOST</button>\n            <button id="del" style="display: none">删除</button>\n        </div>\n    </div>\n</div>'), $.ajax({
